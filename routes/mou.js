...
const mou = require(__dirname + "../../controllers/mou_controller");
...
router.put('/', [
        body('mou_id').trim().notEmpty().isInt(),
...
router.get('/:mou_id', [param('mou_id').isInt()], validate, mou.get);

router.get('/', mou.getAll);
...
router.delete('/:mou_id', [param('mou_id').trim().notEmpty().isInt()], validate, mou.deleted);
